                    ...
                    return (
                      <NavigationMenuItem className="w-full" key={link.label}>
                        <NavigationMenuLink
                          ...
                          href={link.href}>
                          <Icon aria-hidden="true" className="text-muted-foreground/80" size={16} />
        ...
        <div className="flex flex-1 items-center justify-end gap-2">
          <div className="relative">
            <Input
              ...
              type="search" />
            <div
              className="pointer-events-none absolute inset-y-0 start-0 flex items-center justify-center ps-2 text-muted-foreground/80 peer-disabled:opacity-50">
              <SearchIcon size={16} />
            </div>
          </div>
        </div>
